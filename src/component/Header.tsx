...
export const Header = ({lang}:{lang:LocaleKeysType}) => {

    return (
        <div className="sticky top-0 left-0 w-full px-6 py-3 bg-primaryGold05 z-[999] ">
            <div className="flex justify-between items-center w-full h-[60px]">
                ...
                <div className="h-[60px] w-auto flex gap-6 items-center">
                   ...
                   <MenuBtn 
                        containerClass={"h-full flex items-center"}
                        lang={lang}
                    />
